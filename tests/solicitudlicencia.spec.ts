...
test('test', async ({ page }) => {
  ...
  await page.locator('[href="/solicitud-licencia"]').click();
  await page.waitForTimeout(500);

//Selecionamos el tipo de licencia
  await page.getByRole('textbox', { name: 'Tipo de licencia a solicitar*' }).click();
  await page.waitForTimeout(500);
  await page.getByText('ESTUDIOS').click();
  await page.waitForTimeout(500);

//Selecionamos el tipo tipo de tiempo
  await page.getByRole('textbox', { name: 'Tipo de distribución de tiempo' }).click();
  await page.waitForTimeout(500);
  await page.getByText('TIEMPO COMPLETO').click();
  await page.waitForTimeout(500);

  // damos doble clic al primer calendario para seleccionar la fecha
  ...
  await fecha.getByText('2', { exact: true }).click();
  await page.waitForTimeout(500);

//Seleccionamos la hora
  await page.getByRole('textbox', { name: 'Hora *' }).first().click({ force: true });
  await page.waitForTimeout(500);
...
// damos doble clic al segundo calendario para seleccionar la fecha
  ...
  await fecha.getByText('2', { exact: true }).nth(1).click();
  await page.waitForTimeout(500);

//Seleccionamos la hora
  await page.getByRole('textbox', { name: 'Hora *' }).nth(1).click({ force: true });
  await page.waitForTimeout(500);
  await page.getByText('04', { exact: true }).nth(1).click();
  await page.waitForTimeout(300);
  await page.getByText('00', { exact: true }).nth(1).click();
  await page.waitForTimeout(300);
  await page.getByText('PM', { exact: true }).nth(1).click();
  await page.waitForTimeout(500);
...
//Agregamos el dia y hora a la tabla
...
//Nombre del archivo
  await page.getByRole('textbox', { name: 'Nombre del archivo*' }).click();
  await page.getByRole('textbox', { name: 'Nombre del archivo*' }).fill('TEST');
